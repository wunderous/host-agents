...
fix(host-agent): remove LiteRT and align Llama inventory with tunnel catalog

Drop LiteRT LM operations from the Go agent, register helm/artifact standalone tools, and keep Incus inventory and Llama GPU unit behavior aligned with dogfood tunnel execution.
EOF
