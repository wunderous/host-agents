...
func StandaloneToolDefinitions() []ToolDefinition {
	defs := []ToolDefinition{
		...
		}, []string{"bindingId", "endpoint", "localTarget", "tunnelToken"}), OutputSchema: map[string]any{"type": "object", "required": []string{"contractVersion", "ready", "bindingId", "endpoint", "localTarget", "scope", "serviceName", "serviceFile", "tokenFile", "artifact", "origin", "publicAuth"}}, Meta: map[string]any{"effect": "credential_bearing", "needsApproval": true, "resourceCost": map[string]any{"class": "heavy", "cpuCores": 2, "memoryBytes": 2147483648, "tasks": 8}}},
